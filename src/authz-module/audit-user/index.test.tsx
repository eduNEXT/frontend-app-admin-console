...
describe('AuditUserPage', () => {
  ...
  describe('course authoring flag', () => {
    ...
    it('hides a course assignment row when authoring is disabled for the course', async () => {
      ...
      expect(screen.queryByText('Course Staff')).not.toBeInTheDocument();
    ...
    it('shows the course assignment row with its delete action when authoring is enabled', async () => {
      renderWithRouter();
